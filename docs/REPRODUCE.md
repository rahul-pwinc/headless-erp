...
make boundary        # the enforcement boundary, 10 checks (reports/boundary.json)
...
| `make boundary` | ~5s | provisions the role/user/Server Script, then runs 10 checks; verified 11/11 (2026-09-08) |
